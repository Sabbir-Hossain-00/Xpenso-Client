...
export const Register = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col-reverse md:flex-row justify-between items-center relative ">
      <button onClick={()=> navigate("/")} className="btn btn-xs md:btn-md absolute top-4 bg-blue-400 left-4 border-none shadow-none">Go Back Home</button>
        ...
        <div className="card bg-base-100 w-full max-w-sm  rounded-lg">
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                className="btn btn-neutral w-full mt-4 text-white bg-blue-500 border-none hover:bg-blue-600"
              >
                Sign Up
              </button>
            </form>
      ...
      <div className="bg-blue-500 w-full md:h-screen h-fit py-10 flex flex-col justify-center items-center">
        <div className="text-white flex flex-col items-center gap-2">
          <h1 className=" md:text-5xl text-4xl  font-semibold text-center mt-6 md:mt-0">
            Welcome Back !
          </h1>
